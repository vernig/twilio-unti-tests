...
const context = {
  CLIENT_ROUTING_URL:
    'https://test-mptaskcontrol.azurewebsites.net/api/voice/Webhook/HandleIncomingCall',
...
describe('add-conference-participant', () => {
  ...
  it('executes', done => {
    const tokenFunction = require('./functions/twilio/add-conference-participant')
      .handler;
    var e = {
      taskSid: '',
      to: '',
